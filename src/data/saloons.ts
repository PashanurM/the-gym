...
export const saloons: Saloon[] = [
  {
    ...
    name: "Strength Floor",
    description:
      "Olympic platforms, competition racks, and specialty bars. Built for serious lifting with open sightlines and dense rubber flooring.",
    capacity: 40,
  ...
  },
  {
    ...
    name: "Cycle Studio",
    description:
      "Immersive ride room with synced lighting and instructor-led climbs. High-energy sessions that feel like a night ride.",
    capacity: 28,
  ...
  },
  {
    ...
    name: "Recovery Suite",
    description:
      "Quiet zone for soft tissue work, breath practice, and post-session reset. Where intensity meets restoration.",
    capacity: 16,
  ...
  },
  {
    ...
    name: "Combat Bay",
    description:
      "Heavy bags, open mats, and sparring space for boxing and functional fight training.",
    capacity: 22,
